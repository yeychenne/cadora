...
> The **manuals render right here on GitHub**. The **journeys** and **design specs** are self-contained
> HTML — open them in a browser (or view the rendered docs site). New to Cadora? Start with
> [Run a gated workflow](run-a-gated-workflow/user-journey.html), then follow the run's own evidence
> through [Gates & integrity](gates-and-integrity/user-journey.html) and the
> [Evidence pack](evidence-pack/user-journey.html).
...
[Journey](run-a-gated-workflow/user-journey.html) · [Manual](run-a-gated-workflow/user-manual.md) · [Design](run-a-gated-workflow/design-spec.html)
...
[Journey](gates-and-integrity/user-journey.html) · [Manual](gates-and-integrity/user-manual.md) · [Design](gates-and-integrity/design-spec.html)
...
[Journey](human-review/user-journey.html) · [Manual](human-review/user-manual.md) · [Design](human-review/design-spec.html)
...
[Journey](evidence-pack/user-journey.html) · [Manual](evidence-pack/user-manual.md) · [Design](evidence-pack/design-spec.html)
...
[Journey](cost-finops/user-journey.html) · [Manual](cost-finops/user-manual.md) · [Design](cost-finops/design-spec.html)
...
[Journey](multi-backend/user-journey.html) · [Manual](multi-backend/user-manual.md) · [Design](multi-backend/design-spec.html)
...
[Journey](resume-remediation/user-journey.html) · [Manual](resume-remediation/user-manual.md) · [Design](resume-remediation/design-spec.html)
...
[Journey](compare-evaluate/user-journey.html) · [Manual](compare-evaluate/user-manual.md) · [Design](compare-evaluate/design-spec.html)
...
[Journey](aidlc-method/user-journey.html) · [Manual](aidlc-method/user-manual.md) · [Design](aidlc-method/design-spec.html)
...
[Journey](deliverable-pack/user-journey.html) · [Manual](deliverable-pack/user-manual.md) · [Design](deliverable-pack/design-spec.html)
...
[Journey](mcp-server/user-journey.html) · [Manual](mcp-server/user-manual.md) · [Design](mcp-server/design-spec.html)
...
[Journey](journey-first-builds/user-journey.html) · [Manual](journey-first-builds/user-manual.md) · [Design](journey-first-builds/design-spec.html)

---

*Looking for the bigger picture first? Read [the vision](../vision.md), see [how gates decide *green*](../verification-gates.md),
or skim the [one-page overview](../index.html).*
